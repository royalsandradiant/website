...
export const metadata = {
  ...
  description:
    "Pick any 2 or 3 items from our curated combo collection and get an exclusive bundle discount!",
};
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-8">
            <div className="bg-secondary/50 p-4 rounded-xl border border-border">
              <p className="text-sm text-foreground/50 uppercase tracking-widest mb-1">
                Buy 2 Get
              </p>
              <p className="text-3xl font-bold text-primary">
                {settings.comboDiscount2}% OFF
              </p>
            </div>
            <div className="bg-secondary/50 p-4 rounded-xl border border-border">
              <p className="text-sm text-foreground/50 uppercase tracking-widest mb-1">
              ...
              <p className="text-3xl font-bold text-primary">
                {settings.comboDiscount3}% OFF
              </p>
            </div>
          </div>
          <p className="text-lg text-foreground/60 max-w-2xl mx-auto mb-6">
            Pick any{" "}
            <span className="font-semibold text-foreground">2 or 3 items</span>{" "}
            from our curated selection and save with our special bundle
            discounts!
          </p>
        </div>
