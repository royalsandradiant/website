...
import { MinusIcon, Package, PlusIcon, TrashIcon } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import { useMemo } from "react";
import { type CartItem, useCart } from "@/app/lib/cart-context";
...
export default function CartPage() {
    ...
    return (
      <div className="container mx-auto flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
        ...
        <p className="mb-8 text-foreground/60 max-w-md">
          ...
          latest collections and find something special.
        </p>
        <Link
          href="/"
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="mb-8 font-display text-3xl md:text-4xl text-foreground">
        Shopping Cart
      </h1>
                ...
                return (
                  ...
                  >
                    <span className="text-foreground/70">
                      Combo Deal ({comboItems.length} items)
                    </span>
