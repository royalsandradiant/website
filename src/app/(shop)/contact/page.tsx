...
import { type ContactFormState, submitContactForm } from "@/app/lib/actions";
      ...
      >
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-foreground/70 leading-relaxed">
            ...
            our collections, need styling advice, or want to share your Royals
            ...
            {state.success ? (
              ...
              <form action={formAction} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div
                    className="opacity-0 absolute -z-10 select-none pointer-events-none"
                    aria-hidden="true"
                  >
