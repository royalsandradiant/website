...
import type { Coupon } from "@/app/lib/definitions";

export default function CouponSettingsForm({
  initialCoupons,
}: {
  ...
  return (
    <div className="space-y-6">
      <form
        ...
        className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end bg-white p-4 rounded-lg border border-border shadow-sm"
      >
        <div>
          ...
          <tbody className="divide-y divide-border bg-white">
            {coupons.length === 0 ? (
              <tr>
                <td
                  colSpan={4}
                  className="px-4 py-8 text-center text-foreground/50 italic"
                >
